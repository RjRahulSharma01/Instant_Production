...
const STATIC_ROUTES = [
  ...
  ['/services/ai-content-strategy', 0.8], ['/services/video-production', 0.8],
  ['/services/performance-marketing', 0.8], ['/services/influencer-marketing', 0.8],
  ['/services/website-development', 0.8],
