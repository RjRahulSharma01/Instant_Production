...
tags:
  ...
  - Fintech
keywords:
  - sebi common advertisement code 2026
  - finfluencer celebrity definition sebi
  - sebi influencer ad approval broker
  - securities ad rules india influencer
related:
...
If you run influencer campaigns for a broker, an investment adviser, a research analyst or an AMC, SEBI's draft Common Advertisement Code puts every creator above 5 lakh followers into the same bucket as a Bollywood lead. That means prior approval before the ad runs, and a hard ban on the creator saying anything specific about the product. SEBI released the consultation paper on 23 June 2026 and closed comments on 14 July 2026.

The paper is worth reading properly because it does two opposite things at once. It removes prior approval for most ads, and then puts it straight back for the kind of ad financial brands actually spend on.

## What the code replaces

Right now, stock brokers, depository participants, investment advisers, research analysts, online bond platform providers and portfolio managers each sit under separate advertising rules. The draft folds all seven categories into one code housed inside the SEBI (Intermediaries) Regulations, 2008. Mutual funds and their AMCs are covered too.
...
Celebrity ads keep their prior-approval requirement, and SEBI has widened who counts. Under the draft, a person is a celebrity if they meet any one of these:

| Trigger | Threshold in the draft |
|---|---|
| Social following | More than 5 lakh followers or subscribers on any *single* handle |
| Celebrity index | Top 50 of a national publication's index, current or up to a year old |
| Screen work | Lead role in any film, TV serial, TV show or OTT web series |
| Sport | Represented the national team or competed internationally |
| Hosting | Anchored a TV programme for one season or 10 episodes |
| Reality format | Won, finished runner-up, or cleared qualifying rounds |
| Virtual character | A fictional avatar with lifelike human traits that influences its audience |

The last row matters more than it looks. An AI presenter reading a scripted explainer for a broking app is a celebrity under this draft, with the same approval path as a signed film star.

"Any single handle" is the phrase to plan around. A creator with 3 lakh on Instagram and 6 lakh on YouTube is a celebrity even if the campaign only buys the Instagram grid.

Once someone crosses that line, SEBI sets tight limits on what they can say. A celebrity may promote the regulated entity or its brand and may list the products it offers. A celebrity may not make any claim about a specific product or service. And the cost cannot be passed on to clients or charged to a mutual fund scheme.

> The creators who move the needle are precisely the creators the code slows down.

## What this does to a fintech content calendar

Most clients we work with in this space run a barbell: two or three large creators for reach, then twenty to forty mid-tier accounts for frequency. This draft splits that barbell down the middle. The mid-tier half stays on 24-hour reporting and keeps moving at content speed. The large half goes back into an approval queue, and SEBI's paper does not say how supervisory bodies would clear that volume.
...
## The rest of the draft has teeth too

Beyond celebrities, the code bans a list of things that show up in securities creative constantly:
...
The ad code is not a standalone move. SEBI has been narrowing this space for two years:
...
Sources: [SEBI consultation paper on the Common Advertisement Code](https://www.sebi.gov.in/reports-and-statistics/reports/jun-2026/consultation-paper-on-common-advertisement-code-for-specified-sebi-regulated-entities_102304.html) · [MediaNama on the draft ad code](https://www.medianama.com/2026/06/223-lowdown-sebi-treat-finfluencers-ai-avatars-celebrities-under-new-ad-code/) · [MediaNama on the 1 May 2026 disclosure circular](https://www.medianama.com/2026/02/223-sebi-mandates-registration-number-on-social-media/) · [PPC Land on Meta's SEBI verification requirement](https://ppc.land/meta-mandates-sebi-verification-for-india-securities-ads/) · [Aarna Law on SEBI's 2026 digital compliance rules](https://www.mondaq.com/india/securities/1759228/sebis-new-digital-compliance-rules-what-investment-advisers-must-know-in-2026)
