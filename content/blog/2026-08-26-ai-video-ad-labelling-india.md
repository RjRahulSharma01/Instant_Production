---
title: AI video ads in India now need a label
...
tags:
  ...
  - Compliance
keywords:
  - ai generated ad labelling india
  - it amendment rules 2026 sgi
  - asci ai labelling guidelines
related:
...
If your ad contains a realistic AI-generated person, place or product demo, it now needs a visible label in India. MeitY notified the Information Technology (Intermediary Guidelines and Digital Media Ethics Code) Amendment Rules, 2026 on 10 February 2026, in force from 20 February. ASCI followed on 8 May 2026 with draft labelling guidelines for advertisers specifically.

Two different bodies, two different jobs. The IT Rules bind the platform. The ASCI guidelines bind you.

## What the IT Rules actually cover

The Amendment Rules introduce a defined term: synthetically generated information, or SGI. Rule 2(1)(wa) describes it as audio, visual or audio-visual information artificially or algorithmically created or altered using a computer resource, in a manner that appears real, authentic or true, and depicts a person or event in a way likely to be perceived as indistinguishable from a natural person or real-world event.

Read that definition carefully, because most people misread it in the same direction. It is not "made with AI." It is "made with AI and passes as real."
...
Takedown windows also compressed sharply: three hours for a court order or government intimation, down from 36. Two hours for non-consensual or morphed imagery, down from 24. Grievance resolution moved from 15 days to seven.
...
ASCI's draft, published 8 May 2026 with comments open until 13 June 2026, is aligned to the Amendment Rules but points at a different party. It sorts AI use in advertising into three risk tiers based on consumer impact, not on the technology.
...
**Synthetic presenters.** An AI avatar delivering a product pitch is a realistic depiction of a person who does not exist. Medium risk under ASCI, SGI under the IT Rules. Label it.

**Product demonstrations that never happened.** A generated shot of a serum absorbing, a car cornering, an app screen that is not the real UI. This is where a labelling problem quietly becomes a claim-substantiation problem, which is a much worse conversation to have with a regulator.

**AI replicas of real people.** A generated version of a founder, an actor or a creator. Consent and personality rights sit on top of the labelling question here, and the two-hour takedown window for morphed imagery means a complaint moves faster than your approvals chain can.

We now ask one question in the review pass before anything ships: *does any frame in this ad ask a viewer to believe something is real when it is not?* If yes, it needs a label and a second look at the claim underneath it. That question replaced a much longer checklist and catches more.
